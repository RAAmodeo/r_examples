...
Full documentation for 2019 poverty data from Small Area Income and Poverty Estimates (SAIPE) Program available [here](https://www.census.gov/programs-surveys/saipe.html)

```{r pov19, include = FALSE}
povest19 <- read_csv(here::here("data", "PovertyEstimates.csv"))
...
## See the Code
The associated .Rmd file is available at <https://github.com/RAAmodeo/r_examples/usmap>.